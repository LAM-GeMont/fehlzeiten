    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent>
        ...
        >
          {(props) => (
            <Form>
              <ModalHeader>Neue:r Schüler:in erstellen</ModalHeader>
              <ModalCloseButton />
              <ModalBody>
                <Field name="name" validate={validateName}>
                  {({ field, form }) => (
                    <FormControl isInvalid={form.errors.name && form.touched.name}>
                      <FormLabel htmlFor="name">Name des/der Schülers/Schülerin*</FormLabel>
                ...
                <Field name="tutorium">
                  {({ field, form }) => (
                    <FormControl>
                      <FormLabel htmlFor="tutorium">Tutorium des/der Schülers/Schülerin</FormLabel>
                      <Input {...field} id="tutorium" placeholder="Tutorium" />
                      <FormErrorMessage>{form.errors.name}</FormErrorMessage>
                    </FormControl>
                  )}
                </Field>
