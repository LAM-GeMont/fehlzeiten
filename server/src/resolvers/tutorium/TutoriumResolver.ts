...
import { createTutorium, TutoriumCreateInput, TutoriumCreateResponse } from './create'
import { TutoriumDeleteInput, TutoriumDeleteResponse, deleteTutorium } from './delete'
